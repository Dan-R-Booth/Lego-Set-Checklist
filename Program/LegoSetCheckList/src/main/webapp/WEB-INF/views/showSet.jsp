	...
	<body onload="setup()">
		...
		<div class="sticky-top" data-toggle="affix">
			...
			<div class="d-none" id="setAddedToListAlert" role="alert">
				<i class="fa fa-check-circle"></i> <strong>Set: "${set_number}" added to list: "<a href="/set_list=${set_list.listName}" onclick="openLoader()" data-bs-toggle="tooltip" title="View Set List">${set_list.listName}</a>"</strong>
